...
def plot_curve(loss_list, loss_idxs, train_precision_list, train_precision_idxs, valid_precision_list, valid_precision_idxs):
	...
	plt.ylabel('accuracy')
	# plt.show()
	plt.savefig('E:\\Github\cifar10-tensorflow\\exps\cifar10-v1\cifar10-v1.png', dpi=72, format='png')


loss_list, train_precision_list, valid_precision_list = load_log('E:\\Github\cifar10-tensorflow\\exps\cifar10-v1\cifar10-v1.txt')
