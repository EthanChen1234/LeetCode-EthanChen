...
def plot_curve(loss_list1, loss_idxs1, train_precision_list1, train_precision_idxs1, valid_precision_list1, valid_precision_idxs1,
	...
	plt.legend((p1[0], p2[0], p3[0], p4[0]), ('only flip', 'only crop', 'only whiten', 'all'))
	plt.grid(True)
	...
	plt.legend((p5[0], p6[0], p7[0], p8[0]), ('only flip', 'only crop', 'only whiten', 'all'))
	plt.grid(True)
...
loss_list2, train_precision_list2, valid_precision_list2 = load_log('E:\\Github\cifar10-tensorflow\\exps\cifar10-v2\cifar10-v4.txt')
loss_list3, train_precision_list3, valid_precision_list3 = load_log('E:\\Github\cifar10-tensorflow\\exps\cifar10-v2\cifar10-v5.txt')
loss_list4, train_precision_list4, valid_precision_list4 = load_log('E:\\Github\cifar10-tensorflow\\exps\cifar10-v2\cifar10-v2.txt')
